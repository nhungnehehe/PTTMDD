...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.mainlayoutlogin), (v, insets) -> {
    ...
    private void setupBroadcastReceiver() {
        networkReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                //chut nua se tu dong nhay vao day khi internet bi thay doi trang thai
                ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService(CONNECTIVITY_SERVICE);
                NetworkInfo networkInfo = connectivityManager.getActiveNetworkInfo();
                if(networkInfo != null && networkInfo.isConnected()){
                    //vao day tuc la co internet (khong quan tam wifi hay 4G)
                    ...
                    txtNetworkType.setText("Not Internet Connected!");
    ...
    private void addViews() {
        ...
        mainlayout = findViewById(R.id.mainlayoutlogin);
...
//        Employee emp = ec.login(sqLiteConnector,usr,pwd);
        //--> Cach o tren oke hon su dung duoc nhieu cho, muon su dung dong o duoi cung duoc
